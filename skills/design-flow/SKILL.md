...
- **B. Vincent a explore dans Claude Design** → il fait "Handoff to Claude Code". Recuperer le code, le **nettoyer aux conventions du projet** (composants ui/, tokens DESIGN.md), pas le coller brut.
